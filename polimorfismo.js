class Comment {
    constructor({
        content, studentName, studentRole = "Estudiante",
    }){
...
class Student {
    ...
    publicarComentario(comentContent){
        const comment = new Comment({content: comentContent, studentName: this.name});
        comment.publicar()
    }
}
...
class TeacherStudent extends Student{
    ...
    publicarComentario(comentContent){
        const comment = new Comment({content: comentContent, studentName: this.name, studentRole: "Profesor"});
        comment.publicar()
    }
}
